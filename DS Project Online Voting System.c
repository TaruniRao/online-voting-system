...
node *voter_insert(node *start)
{
    ...
    if(R==0){
	    ...
	    while(temp!=NULL)
	    {
	        if((strcmp(temp->aadhar,"10001")==0&& strcmp(temp->name,"Vigna Reddy")==0 &&strcmp(temp->birth_date,"22-02-2004")==0) ||
	        (strcmp(temp->aadhar,"10002")==0&& strcmp(temp->name,"Taruni Rao")==0 &&strcmp(temp->birth_date,"22-08-2004")==0)||
	        (strcmp(temp->aadhar,"10003")==0&& strcmp(temp->name,"Chaitanya Vikas")==0 &&strcmp(temp->birth_date,"22-11-1999")==0)||
	        (strcmp(temp->aadhar,"10004")==0&& strcmp(temp->name,"Sindhu Palla")==0 &&strcmp(temp->birth_date,"14-04-2004")==0)||
	        (strcmp(temp->aadhar,"10005")==0&& strcmp(temp->name,"Priyanka Rebba")==0 &&strcmp(temp->birth_date,"22-07-2004")==0)||
	        (strcmp(temp->aadhar,"10006")==0&& strcmp(temp->name,"Vaishnav Deeti")==0 &&strcmp(temp->birth_date,"26-10-2004")==0)||
	        (strcmp(temp->aadhar,"10007")==0&& strcmp(temp->name,"Tarun")==0 &&strcmp(temp->birth_date,"20-01-2002")==0)||
	        (strcmp(temp->aadhar,"10008")==0&& strcmp(temp->name,"NTR")==0 &&strcmp(temp->birth_date,"20-05-1983")==0)||
	        (strcmp(temp->aadhar,"10009")==0&& strcmp(temp->name,"Vamsi")==0 &&strcmp(temp->birth_date,"01-01-2004")==0)||
	        (strcmp(temp->aadhar,"10010")==0&& strcmp(temp->name,"Shreha")==0 &&strcmp(temp->birth_date,"15-04-2004")==0))
